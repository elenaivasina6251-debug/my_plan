(() => {
  ...
  function downloadTasksCsv() {
    ...
    const csvContent = createCsvContent(storedTasks);
    const fileName = `tasks-export-${formatIsoDate(new Date())}.csv`;
  ...
  function manualTransferTask(taskId, toDate) {
  ...
  function renderTaskDetails() {
    ...
    taskDetailsTransferDate.value = task.date;
